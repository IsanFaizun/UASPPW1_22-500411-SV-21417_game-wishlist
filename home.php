        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="assets/featured1.jpg" class="w-100" style="opacity: 0.7;" alt="featured1">
              <div class="carousel-caption d-sm-block">
                <h5>Metal Gear Solid: The Phantom Pain</h5>
              </div>
            </div>
            <div class="carousel-item">
              <img src="assets/featured2.jpg" class="w-100" style="opacity: 0.7;" alt="featured2">
              <div class="carousel-caption d-sm-block">
                <h5>Grand Theft Auto V</h5>
              </div>
            </div>
            <div class="carousel-item">
              <img src="assets/featured3.jpg" class="w-100" style="opacity: 0.7;" alt="featured3">
              <div class="carousel-caption d-sm-block">
