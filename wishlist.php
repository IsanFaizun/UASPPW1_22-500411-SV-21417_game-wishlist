...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="wishlist.php">Wishlist</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid fill-container">
        <div class="row mx-5 bg-dark">
            <h3 class="my-4" style="text-align: center;">Your Wishlist</h3>
            <!-- Isi -->
            <table class="table table-dark table-borderless my-5">
                ...
                <?php
                    ...
                    if(mysqli_num_rows($select) > 0){
                        while($fetch_wish = mysqli_fetch_assoc($select)){
                    ?>
                    <tr>
                        <td class="px-5"><img src="<?php echo $fetch_wish['img']; ?>" class="img-fluid" height="140" width="250" alt=""></td>
                        <td><b><?php echo $fetch_wish['name']; ?></b></td>
                        <td><a onclick="return confirm('Are you remove this game from your wishlist?');" class="btn btn-danger btn-sm" href="wishlist.php?remove=<?php echo $fetch_wish['id']; ?>"><b>REMOVE</b></a></td>
                    </tr>
            ...
            <table class="table table-dark table-borderless">
                <tr>
                    <td class="px-5 pt-5"><a class="btn btn-danger" onclick="return confirm('Are you sure to delete all this game from your wishlist?');" href="wishlist.php?delete_all"><b>DELETE ALL</b></a></td>
                </tr>
            </table>
